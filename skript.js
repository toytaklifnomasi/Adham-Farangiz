...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Tayyorlovchi matni (bo'sh bo'lsa ko'rsatilmaydi)
  const muallifEl = document.getElementById('muallif-el');
  if (d.MUALLIF_MATNI && d.MUALLIF_MATNI.trim() !== '') {
    muallifEl.textContent = d.MUALLIF_MATNI;
  } else {
    muallifEl.parentElement.style.display = 'none';
  }
